...
function MiniCalendar({ bookings, enrollments }: { bookings: any[], enrollments: any[] }) {
        ...
        <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-7 gap-1">
                {days.map((day, i) => {
                    ...
                    const hasClass = enrollments.some(e => e.classId?.schedule?.day === dayLabel && e.status === 'active');
